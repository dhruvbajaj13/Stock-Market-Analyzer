...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-900 text-gray-300 py-8 ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="ml-[-40px]">
          ...
          <div className="flex mt-5 space-x-4">
            <a href="#" className="p-2 bg-gray-800 rounded-fulltransition-colors text-white">
              <Image
      ...
      {/* Bottom Bar */}
      <div className="mt-6 border-t-2 border-gray-600 pt-6 mx-8 px-2 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
